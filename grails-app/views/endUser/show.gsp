...
<html>
    ...
    <body>
        ...
        <div id="show-endUser" class="content scaffold-show" role="main">
            ...
            <f:display bean="endUser" />
            <g:form resource="${this.endUser}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.endUser}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
